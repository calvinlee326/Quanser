...
def readVideo():
    ...
    inpImage = cv2.VideoCapture(os.path.join(CWD_PATH, 'QcarVideo.mp4'))
...
while True:
    ...
    # image = cv2.resize(image, (int(1280), int(720)))
    # cv2.imshow("RGB cam", image)
    # image = cv2.imread("CurveLane.png")
    # frame = image.read()
